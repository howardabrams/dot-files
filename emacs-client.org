...
* Font Settings
  ...
  While thicker, my new favorite is [[https://github.com/tonsky/FiraCode][Fira]] as it does symbol ligatures.

  #+BEGIN_SRC elisp
    ;; (setq my/font-family "M+ 1mn")
    ;; (setq my/font-family "Source Code Pro")
    ;; (setq my/font-family "Anonymous Pro")
    (setq my/font-family "Fira Code")
  #+END_SRC
...
* Ligatures in Code
  ...
  With the [[https://github.com/tonsky/FiraCode][Fira Code font]], we can [[https://github.com/tonsky/FiraCode/wiki/Setting-up-Emacs][use this code]] to set up particular
  programming symbols to take up multiple widths:
