...
#+END_SRC
  ...
  I'm not sure I get it, but when I do, update the Gist and this:

  Wanted some pasted text to have quotes around it. Spent a very enjoyable bus ride
  home generalizing it. <3 #emacs https://gist.github.com/howardabrams/9928461
