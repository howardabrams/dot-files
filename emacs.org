...
#+BEGIN_SRC elisp
  (add-to-list 'yas-snippet-dirs "~/.emacs.d/clojure-snippets")
  (add-to-list 'yas-snippet-dirs "~/.emacs.d/snippets")
#+END_SRC

   We have many different JavaScript modes to use, and from Yas'
   point of view, they are all JavaScript, so this bit of magic
   associates the 'javascript' snippets with each mode.
