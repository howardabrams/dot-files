...
#+END_SRC
   ...
   Connect the WSGI files to use the Python environment:
...
*** Refactoring with Rope
    ...
    According to [[http://stackoverflow.com/questions/2855378/ropemacs-usage-tutorial][this discusssion]], we just need to do:
