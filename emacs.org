...
** Better Jumping
   ...
   #+Begin_SRC elisp
     (use-package avy
       :ensure t
       :bind
       ("C-c j"   . avy-goto-word-timer)
       ("A-j"     . avy-goto-word-timer)    ; The Mac Command key
       ("s-j"     . avy-goto-word-timer)    ; The Command key on Linux
       ("A-J"     . avy-pop-mark)           ; The Mac Command key
       ("s-J"     . avy-pop-mark))          ; The Command key on Linux
   #+END_SRC
    ...
    #+BEGIN_SRC elisp
      (use-package perspective
        ...
        (defun persp-update-modestring ()
          "Update `persp-modestring' to reflect the current perspective."
