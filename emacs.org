   ...
   #+BEGIN_SRC elisp
     (use-package whitespace
       ...
       (set-face-attribute 'whitespace-space nil
                           :foreground "#666666" :background nil)
...
** Magit
   ...
   #+BEGIN_SRC elisp
     (use-package magit
       :init
       (use-package magit-blame          :ensure t)
...
** PlantUML and Graphviz
   ...
   #+BEGIN_SRC elisp
     (use-package plantuml-mode
       :ensure t
       :init (let ((plantuml-jar (car (file-expand-wildcards "/usr/local/Cellar/plantuml/*/plantuml*.jar"))))
