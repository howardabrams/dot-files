...
#+BEGIN_SRC elisp
  ...
  (define-key mac-key-mode-map [(alt z)] 'undo)
  (define-key mac-key-mode-map [(alt S-z)] 'redo)
...
#+BEGIN_SRC elisp :tangle no
  (autoload 'auto-complete-config "auto-complete-config"
            "Auto completion for general buffer types." t nil)
