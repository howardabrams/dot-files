...
#+END_SRC
   ...
   *Note:* With [[http://www.emacswiki.org/emacs/InteractivelyDoThings][IDO]], I'm not really bothering with the concept of a
   project anymore. I may just take this section out.
...
*** Coffee
    ...
    Gotta load up CoffeeScript files.

#+BEGIN_SRC elisp
  (setq coffee-command
        (concat (getenv "HOME")
                "/Google Drive/euler-xp/repl"))
#+END_SRC
