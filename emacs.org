...
** PlantUML and Graphviz
   ...
   Install the Graphviz project and [[http://plantuml.sourceforge.net/download.html][PlantUML]] using Homebrew:
   ...
   Then set the "mode" working for editing the files:

   #+BEGIN_SRC elisp
     (use-package graphviz-dot-mode
       :ensure t
       :init (setq plantuml-jar-path (file-expand-wildcards "/usr/local/Cellar/plantuml/*/plantuml*.jar")
               org-plantuml-jar-path (file-expand-wildcards "/usr/local/Cellar/plantuml/*/plantuml*.jar")))
   #+END_SRC
