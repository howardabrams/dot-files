...
** Installing Dependencies
   ...
   *Note:* Version 24 already contains ELPA...
...
#+END_EXAMPLE
    ...
    According to [[http://blog.deadpansincerity.com/2011/05/setting-up-emacs-as-a-javascript-editing-environment-for-fun-and-profit/][these instructions]], we need to get Lintnode,
    however, this can be installed using Marmalade:
...
** JavaScript
   ...
   - Syntax highlight (already done)
   - Syntax verification (with lintnode)
   - Interactive REPL
...
#+END_SRC
   ...
   I've looked at [[http://koansys.com/tech/flymake-mode-for-emacs-javascript-v8-edition][these instructions]] for using V8 as the JavaScript
   REPL engine instead of node.js.
